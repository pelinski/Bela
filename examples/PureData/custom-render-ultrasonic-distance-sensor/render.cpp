// Custom libpd render.cpp to use with HC-SR04 ultrasonic distance sensor.
// The modifications (marked by `#ifdef ULTRASONIC_DISTANCE`) have been taken from the example Sensors/ultrasonic-distance and
// applied on top of
